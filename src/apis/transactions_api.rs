...
pub trait TransactionsApi: Send + Sync {
    async fn cancel_transaction(&self,  params: CancelTransactionParams ) -> Result<models::CancelTransactionResponse, Error<CancelTransactionError>>;
    async fn create_transaction(&self,  params: CreateTransactionParams ) -> Result<models::CreateTransactionResponse, Error<CreateTransactionError>>;
    async fn drop_transaction(&self,  params: DropTransactionParams ) -> Result<models::DropTransactionResponse, Error<DropTransactionError>>;
    async fn estimate_transaction_fee(&self,  params: EstimateTransactionFeeParams ) -> Result<models::EstimatedTransactionFeeResponse, Error<EstimateTransactionFeeError>>;
    async fn freeze_transaction(&self,  params: FreezeTransactionParams ) -> Result<models::FreezeTransactionResponse, Error<FreezeTransactionError>>;
    async fn get_transaction(&self,  params: GetTransactionParams ) -> Result<models::TransactionResponse, Error<GetTransactionError>>;
    async fn get_transaction_by_external_id(&self,  params: GetTransactionByExternalIdParams ) -> Result<models::TransactionResponse, Error<GetTransactionByExternalIdError>>;
    async fn get_transactions(&self,  params: GetTransactionsParams ) -> Result<Vec<models::TransactionResponse>, Error<GetTransactionsError>>;
    async fn rescan_transactions_beta(&self,  params: RescanTransactionsBetaParams ) -> Result<Vec<models::ValidatedTransactionsForRescan>, Error<RescanTransactionsBetaError>>;
    async fn set_confirmation_threshold_by_transaction_hash(&self,  params: SetConfirmationThresholdByTransactionHashParams ) -> Result<models::SetConfirmationsThresholdResponse, Error<SetConfirmationThresholdByTransactionHashError>>;
    async fn set_transaction_confirmation_threshold(&self,  params: SetTransactionConfirmationThresholdParams ) -> Result<models::SetConfirmationsThresholdResponse, Error<SetTransactionConfirmationThresholdError>>;
    async fn unfreeze_transaction(&self,  params: UnfreezeTransactionParams ) -> Result<models::UnfreezeTransactionResponse, Error<UnfreezeTransactionError>>;
}
...
impl TransactionsApi for TransactionsApiClient {
    ...
    async fn cancel_transaction(&self,  params: CancelTransactionParams ) -> Result<models::CancelTransactionResponse, Error<CancelTransactionError>> {
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            ...
            let local_var_entity: Option<CancelTransactionError> = serde_json::from_str(&local_var_content).ok();
    ...
    async fn drop_transaction(&self,  params: DropTransactionParams ) -> Result<models::DropTransactionResponse, Error<DropTransactionError>> {
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            ...
            let local_var_entity: Option<DropTransactionError> = serde_json::from_str(&local_var_content).ok();
            let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
            Err(Error::ResponseError(local_var_error))
        }
    }
    ...
    async fn estimate_transaction_fee(&self,  params: EstimateTransactionFeeParams ) -> Result<models::EstimatedTransactionFeeResponse, Error<EstimateTransactionFeeError>> {
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            ...
            let local_var_entity: Option<EstimateTransactionFeeError> = serde_json::from_str(&local_var_content).ok();
            let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
            Err(Error::ResponseError(local_var_error))
        }
    }
    ...
    async fn freeze_transaction(&self,  params: FreezeTransactionParams ) -> Result<models::FreezeTransactionResponse, Error<FreezeTransactionError>> {
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            ...
            let local_var_entity: Option<FreezeTransactionError> = serde_json::from_str(&local_var_content).ok();
            let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
            Err(Error::ResponseError(local_var_error))
        }
    }
    ...
    async fn get_transaction_by_external_id(&self,  params: GetTransactionByExternalIdParams ) -> Result<models::TransactionResponse, Error<GetTransactionByExternalIdError>> {
        ...
        let GetTransactionByExternalIdParams {
            external_tx_id,
        } = params;
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            ...
            let local_var_entity: Option<GetTransactionByExternalIdError> = serde_json::from_str(&local_var_content).ok();
            let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
            Err(Error::ResponseError(local_var_error))
        }
    }
    ...
    async fn rescan_transactions_beta(&self,  params: RescanTransactionsBetaParams ) -> Result<Vec<models::ValidatedTransactionsForRescan>, Error<RescanTransactionsBetaError>> {
        ...
        let local_var_uri_str = format!("{}/transactions/rescan", local_var_configuration.base_path);
        let mut local_var_req_builder = local_var_client.request(reqwest::Method::POST, local_var_uri_str.as_str());
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            ...
            let local_var_entity: Option<RescanTransactionsBetaError> = serde_json::from_str(&local_var_content).ok();
            let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
            Err(Error::ResponseError(local_var_error))
        }
    }
    ...
    async fn set_confirmation_threshold_by_transaction_hash(&self,  params: SetConfirmationThresholdByTransactionHashParams ) -> Result<models::SetConfirmationsThresholdResponse, Error<SetConfirmationThresholdByTransactionHashError>> {
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            ...
            let local_var_entity: Option<SetConfirmationThresholdByTransactionHashError> = serde_json::from_str(&local_var_content).ok();
            let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
            Err(Error::ResponseError(local_var_error))
        }
    }
    ...
    async fn set_transaction_confirmation_threshold(&self,  params: SetTransactionConfirmationThresholdParams ) -> Result<models::SetConfirmationsThresholdResponse, Error<SetTransactionConfirmationThresholdError>> {
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            ...
            let local_var_entity: Option<SetTransactionConfirmationThresholdError> = serde_json::from_str(&local_var_content).ok();
            let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
            Err(Error::ResponseError(local_var_error))
        }
    }
    ...
    async fn unfreeze_transaction(&self,  params: UnfreezeTransactionParams ) -> Result<models::UnfreezeTransactionResponse, Error<UnfreezeTransactionError>> {
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            ...
            let local_var_entity: Option<UnfreezeTransactionError> = serde_json::from_str(&local_var_content).ok();
            let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
            Err(Error::ResponseError(local_var_error))
        }
    }

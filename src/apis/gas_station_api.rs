...
pub trait GasStationApi: Send + Sync {
    async fn get_gas_station_by_asset_id(&self,  params: GetGasStationByAssetIdParams ) -> Result<models::GasStationPropertiesResponse, Error<GetGasStationByAssetIdError>>;
    async fn get_gas_station_info(&self, ) -> Result<models::GasStationPropertiesResponse, Error<GetGasStationInfoError>>;
    async fn update_gas_station_configuration(&self,  params: UpdateGasStationConfigurationParams ) -> Result<models::EditGasStationConfigurationResponse, Error<UpdateGasStationConfigurationError>>;
    async fn update_gas_station_configuration_by_asset_id(&self,  params: UpdateGasStationConfigurationByAssetIdParams ) -> Result<models::EditGasStationConfigurationResponse, Error<UpdateGasStationConfigurationByAssetIdError>>;
}
...
impl GasStationApi for GasStationApiClient {
    ...
    async fn get_gas_station_by_asset_id(&self,  params: GetGasStationByAssetIdParams ) -> Result<models::GasStationPropertiesResponse, Error<GetGasStationByAssetIdError>> {
        ...
        let GetGasStationByAssetIdParams {
            asset_id,
        } = params;
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            ...
            let local_var_entity: Option<GetGasStationByAssetIdError> = serde_json::from_str(&local_var_content).ok();
    ...
    async fn get_gas_station_info(&self, ) -> Result<models::GasStationPropertiesResponse, Error<GetGasStationInfoError>> {
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            ...
            let local_var_entity: Option<GetGasStationInfoError> = serde_json::from_str(&local_var_content).ok();
            let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
            Err(Error::ResponseError(local_var_error))
        }
    }
    ...
    async fn update_gas_station_configuration(&self,  params: UpdateGasStationConfigurationParams ) -> Result<models::EditGasStationConfigurationResponse, Error<UpdateGasStationConfigurationError>> {
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            ...
            let local_var_entity: Option<UpdateGasStationConfigurationError> = serde_json::from_str(&local_var_content).ok();
            let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
            Err(Error::ResponseError(local_var_error))
        }
    }
    ...
    async fn update_gas_station_configuration_by_asset_id(&self,  params: UpdateGasStationConfigurationByAssetIdParams ) -> Result<models::EditGasStationConfigurationResponse, Error<UpdateGasStationConfigurationByAssetIdError>> {
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            ...
            let local_var_entity: Option<UpdateGasStationConfigurationByAssetIdError> = serde_json::from_str(&local_var_content).ok();
            let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
            Err(Error::ResponseError(local_var_error))
        }
    }

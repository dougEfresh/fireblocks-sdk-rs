...
pub trait WhitelistedExternalWalletsApi: Send + Sync {
    async fn add_asset_to_external_wallet(&self,  params: AddAssetToExternalWalletParams ) -> Result<models::ExternalWalletAssetDetail, Error<AddAssetToExternalWalletError>>;
    async fn create_external_wallet(&self,  params: CreateExternalWalletParams ) -> Result<models::UnmanagedExternalWallet, Error<CreateExternalWalletError>>;
    async fn delete_external_wallet(&self,  params: DeleteExternalWalletParams ) -> Result<(), Error<DeleteExternalWalletError>>;
    async fn get_external_wallet(&self,  params: GetExternalWalletParams ) -> Result<models::UnmanagedExternalWallet, Error<GetExternalWalletError>>;
    async fn get_external_wallet_asset(&self,  params: GetExternalWalletAssetParams ) -> Result<models::ExternalWalletAssetDetail, Error<GetExternalWalletAssetError>>;
    async fn get_external_wallets(&self, ) -> Result<Vec<models::UnmanagedExternalWallet>, Error<GetExternalWalletsError>>;
    async fn remove_asset_from_external_wallet(&self,  params: RemoveAssetFromExternalWalletParams ) -> Result<(), Error<RemoveAssetFromExternalWalletError>>;
    async fn set_external_wallet_customer_ref_id(&self,  params: SetExternalWalletCustomerRefIdParams ) -> Result<(), Error<SetExternalWalletCustomerRefIdError>>;
}
...
/// struct for passing parameters to the method [`remove_asset_from_external_wallet`]
#[derive(Clone, Debug)]
#[cfg_attr(feature = "bon", derive(::bon::Builder))]
...
/// struct for passing parameters to the method [`set_external_wallet_customer_ref_id`]
#[derive(Clone, Debug)]
#[cfg_attr(feature = "bon", derive(::bon::Builder))]
...
impl WhitelistedExternalWalletsApi for WhitelistedExternalWalletsApiClient {
    ...
    async fn add_asset_to_external_wallet(&self,  params: AddAssetToExternalWalletParams ) -> Result<models::ExternalWalletAssetDetail, Error<AddAssetToExternalWalletError>> {
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            ...
            let local_var_entity: Option<AddAssetToExternalWalletError> = serde_json::from_str(&local_var_content).ok();
    ...
    async fn create_external_wallet(&self,  params: CreateExternalWalletParams ) -> Result<models::UnmanagedExternalWallet, Error<CreateExternalWalletError>> {
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            ...
            let local_var_entity: Option<CreateExternalWalletError> = serde_json::from_str(&local_var_content).ok();
            let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
            Err(Error::ResponseError(local_var_error))
        }
    }
    ...
    async fn delete_external_wallet(&self,  params: DeleteExternalWalletParams ) -> Result<(), Error<DeleteExternalWalletError>> {
        ...
        let DeleteExternalWalletParams {
            wallet_id,
        } = params;
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            ...
            let local_var_entity: Option<DeleteExternalWalletError> = serde_json::from_str(&local_var_content).ok();
            let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
            Err(Error::ResponseError(local_var_error))
        }
    }
    ...
    async fn get_external_wallet(&self,  params: GetExternalWalletParams ) -> Result<models::UnmanagedExternalWallet, Error<GetExternalWalletError>> {
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            ...
            let local_var_entity: Option<GetExternalWalletError> = serde_json::from_str(&local_var_content).ok();
            let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
            Err(Error::ResponseError(local_var_error))
        }
    }
    ...
    async fn get_external_wallet_asset(&self,  params: GetExternalWalletAssetParams ) -> Result<models::ExternalWalletAssetDetail, Error<GetExternalWalletAssetError>> {
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            ...
            let local_var_entity: Option<GetExternalWalletAssetError> = serde_json::from_str(&local_var_content).ok();
            let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
            Err(Error::ResponseError(local_var_error))
        }
    }
    ...
    async fn get_external_wallets(&self, ) -> Result<Vec<models::UnmanagedExternalWallet>, Error<GetExternalWalletsError>> {
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            ...
            let local_var_entity: Option<GetExternalWalletsError> = serde_json::from_str(&local_var_content).ok();
            let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
            Err(Error::ResponseError(local_var_error))
        }
    }
    ...
    async fn remove_asset_from_external_wallet(&self,  params: RemoveAssetFromExternalWalletParams ) -> Result<(), Error<RemoveAssetFromExternalWalletError>> {
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            ...
            let local_var_entity: Option<RemoveAssetFromExternalWalletError> = serde_json::from_str(&local_var_content).ok();
            let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
            Err(Error::ResponseError(local_var_error))
        }
    }
    ...
    async fn set_external_wallet_customer_ref_id(&self,  params: SetExternalWalletCustomerRefIdParams ) -> Result<(), Error<SetExternalWalletCustomerRefIdError>> {
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            ...
            let local_var_entity: Option<SetExternalWalletCustomerRefIdError> = serde_json::from_str(&local_var_content).ok();
            let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
            Err(Error::ResponseError(local_var_error))
        }
    }

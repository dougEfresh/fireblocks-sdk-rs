...
pub trait CosignersBetaApi: Send + Sync {
    async fn get_api_key(&self,  params: GetApiKeyParams ) -> Result<models::ApiKey, Error<GetApiKeyError>>;
    async fn get_api_keys(&self,  params: GetApiKeysParams ) -> Result<models::ApiKeysPaginatedResponse, Error<GetApiKeysError>>;
    async fn get_cosigner(&self,  params: GetCosignerParams ) -> Result<models::Cosigner, Error<GetCosignerError>>;
    async fn get_cosigners(&self,  params: GetCosignersParams ) -> Result<models::CosignersPaginatedResponse, Error<GetCosignersError>>;
    async fn rename_cosigner(&self,  params: RenameCosignerParams ) -> Result<models::Cosigner, Error<RenameCosignerError>>;
}
...
impl CosignersBetaApi for CosignersBetaApiClient {
    ...
    async fn get_api_key(&self,  params: GetApiKeyParams ) -> Result<models::ApiKey, Error<GetApiKeyError>> {
        ...
        let local_var_uri_str = format!("{}/cosigners/{cosignerId}/api_keys/{apiKeyId}", local_var_configuration.base_path, cosignerId=crate::apis::urlencode(cosigner_id), apiKeyId=crate::apis::urlencode(api_key_id));
    ...
    async fn get_api_keys(&self,  params: GetApiKeysParams ) -> Result<models::ApiKeysPaginatedResponse, Error<GetApiKeysError>> {
        ...
        let local_var_uri_str = format!("{}/cosigners/{cosignerId}/api_keys", local_var_configuration.base_path, cosignerId=crate::apis::urlencode(cosigner_id));
        let mut local_var_req_builder = local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
    ...
    async fn get_cosigner(&self,  params: GetCosignerParams ) -> Result<models::Cosigner, Error<GetCosignerError>> {
        ...
        let local_var_uri_str = format!("{}/cosigners/{cosignerId}", local_var_configuration.base_path, cosignerId=crate::apis::urlencode(cosigner_id));
        let mut local_var_req_builder = local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            ...
            let local_var_entity: Option<GetCosignerError> = serde_json::from_str(&local_var_content).ok();
            let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
            Err(Error::ResponseError(local_var_error))
        }
    }
    ...
    async fn get_cosigners(&self,  params: GetCosignersParams ) -> Result<models::CosignersPaginatedResponse, Error<GetCosignersError>> {
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            ...
            let local_var_entity: Option<GetCosignersError> = serde_json::from_str(&local_var_content).ok();
            let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
            Err(Error::ResponseError(local_var_error))
        }
    }
    ...
    async fn rename_cosigner(&self,  params: RenameCosignerParams ) -> Result<models::Cosigner, Error<RenameCosignerError>> {
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            ...
            let local_var_entity: Option<RenameCosignerError> = serde_json::from_str(&local_var_content).ok();
            let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
            Err(Error::ResponseError(local_var_error))
        }
    }

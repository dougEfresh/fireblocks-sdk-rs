...
pub trait ContractInteractionsApi: Send + Sync {
    async fn get_deployed_contract_abi(&self,  params: GetDeployedContractAbiParams ) -> Result<models::ContractAbiResponseDto, Error<GetDeployedContractAbiError>>;
    async fn read_call_function(&self,  params: ReadCallFunctionParams ) -> Result<Vec<models::ParameterWithValue>, Error<ReadCallFunctionError>>;
    async fn write_call_function(&self,  params: WriteCallFunctionParams ) -> Result<models::WriteCallFunctionResponseDto, Error<WriteCallFunctionError>>;
}
...
impl ContractInteractionsApi for ContractInteractionsApiClient {
    ...
    async fn get_deployed_contract_abi(&self,  params: GetDeployedContractAbiParams ) -> Result<models::ContractAbiResponseDto, Error<GetDeployedContractAbiError>> {
        ...
        let local_var_uri_str = format!("{}/contract_interactions/base_asset_id/{assetId}/contract_address/{contractAddress}/functions", local_var_configuration.base_path, contractAddress=crate::apis::urlencode(contract_address), assetId=crate::apis::urlencode(asset_id));
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            ...
            let local_var_entity: Option<GetDeployedContractAbiError> = serde_json::from_str(&local_var_content).ok();
    ...
    async fn read_call_function(&self,  params: ReadCallFunctionParams ) -> Result<Vec<models::ParameterWithValue>, Error<ReadCallFunctionError>> {
        ...
        let local_var_uri_str = format!("{}/contract_interactions/base_asset_id/{assetId}/contract_address/{contractAddress}/functions/read", local_var_configuration.base_path, contractAddress=crate::apis::urlencode(contract_address), assetId=crate::apis::urlencode(asset_id));
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            ...
            let local_var_entity: Option<ReadCallFunctionError> = serde_json::from_str(&local_var_content).ok();
            let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
            Err(Error::ResponseError(local_var_error))
        }
    }
    ...
    async fn write_call_function(&self,  params: WriteCallFunctionParams ) -> Result<models::WriteCallFunctionResponseDto, Error<WriteCallFunctionError>> {
        ...
        let local_var_uri_str = format!("{}/contract_interactions/base_asset_id/{assetId}/contract_address/{contractAddress}/functions/write", local_var_configuration.base_path, contractAddress=crate::apis::urlencode(contract_address), assetId=crate::apis::urlencode(asset_id));
        let mut local_var_req_builder = local_var_client.request(reqwest::Method::POST, local_var_uri_str.as_str());
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            ...
            let local_var_entity: Option<WriteCallFunctionError> = serde_json::from_str(&local_var_content).ok();
            let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
            Err(Error::ResponseError(local_var_error))
        }
    }

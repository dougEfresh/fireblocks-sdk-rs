...
pub trait WhitelistedInternalWalletsApi: Send + Sync {
    async fn create_internal_wallet(&self,  params: CreateInternalWalletParams ) -> Result<models::UnmanagedWallet, Error<CreateInternalWalletError>>;
    async fn create_internal_wallet_asset(&self,  params: CreateInternalWalletAssetParams ) -> Result<models::WalletAsset, Error<CreateInternalWalletAssetError>>;
    async fn delete_internal_wallet(&self,  params: DeleteInternalWalletParams ) -> Result<(), Error<DeleteInternalWalletError>>;
    async fn delete_internal_wallet_asset(&self,  params: DeleteInternalWalletAssetParams ) -> Result<(), Error<DeleteInternalWalletAssetError>>;
    async fn get_internal_wallet(&self,  params: GetInternalWalletParams ) -> Result<models::UnmanagedWallet, Error<GetInternalWalletError>>;
    async fn get_internal_wallet_asset(&self,  params: GetInternalWalletAssetParams ) -> Result<models::WalletAsset, Error<GetInternalWalletAssetError>>;
    async fn get_internal_wallets(&self, ) -> Result<Vec<models::UnmanagedWallet>, Error<GetInternalWalletsError>>;
    async fn set_customer_ref_id_for_internal_wallet(&self,  params: SetCustomerRefIdForInternalWalletParams ) -> Result<(), Error<SetCustomerRefIdForInternalWalletError>>;
}
...
/// struct for passing parameters to the method [`set_customer_ref_id_for_internal_wallet`]
#[derive(Clone, Debug)]
#[cfg_attr(feature = "bon", derive(::bon::Builder))]
...
impl WhitelistedInternalWalletsApi for WhitelistedInternalWalletsApiClient {
    ...
    async fn create_internal_wallet(&self,  params: CreateInternalWalletParams ) -> Result<models::UnmanagedWallet, Error<CreateInternalWalletError>> {
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            ...
            let local_var_entity: Option<CreateInternalWalletError> = serde_json::from_str(&local_var_content).ok();
    ...
    async fn create_internal_wallet_asset(&self,  params: CreateInternalWalletAssetParams ) -> Result<models::WalletAsset, Error<CreateInternalWalletAssetError>> {
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            ...
            let local_var_entity: Option<CreateInternalWalletAssetError> = serde_json::from_str(&local_var_content).ok();
            let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
            Err(Error::ResponseError(local_var_error))
        }
    }
    ...
    async fn delete_internal_wallet(&self,  params: DeleteInternalWalletParams ) -> Result<(), Error<DeleteInternalWalletError>> {
        ...
        let DeleteInternalWalletParams {
            wallet_id,
        } = params;
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            ...
            let local_var_entity: Option<DeleteInternalWalletError> = serde_json::from_str(&local_var_content).ok();
            let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
            Err(Error::ResponseError(local_var_error))
        }
    }
    ...
    async fn delete_internal_wallet_asset(&self,  params: DeleteInternalWalletAssetParams ) -> Result<(), Error<DeleteInternalWalletAssetError>> {
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            ...
            let local_var_entity: Option<DeleteInternalWalletAssetError> = serde_json::from_str(&local_var_content).ok();
            let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
            Err(Error::ResponseError(local_var_error))
        }
    }
    ...
    async fn get_internal_wallet(&self,  params: GetInternalWalletParams ) -> Result<models::UnmanagedWallet, Error<GetInternalWalletError>> {
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            ...
            let local_var_entity: Option<GetInternalWalletError> = serde_json::from_str(&local_var_content).ok();
            let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
            Err(Error::ResponseError(local_var_error))
        }
    }
    ...
    async fn get_internal_wallet_asset(&self,  params: GetInternalWalletAssetParams ) -> Result<models::WalletAsset, Error<GetInternalWalletAssetError>> {
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            ...
            let local_var_entity: Option<GetInternalWalletAssetError> = serde_json::from_str(&local_var_content).ok();
            let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
            Err(Error::ResponseError(local_var_error))
        }
    }
    ...
    async fn get_internal_wallets(&self, ) -> Result<Vec<models::UnmanagedWallet>, Error<GetInternalWalletsError>> {
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            ...
            let local_var_entity: Option<GetInternalWalletsError> = serde_json::from_str(&local_var_content).ok();
            let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
            Err(Error::ResponseError(local_var_error))
        }
    }
    ...
    async fn set_customer_ref_id_for_internal_wallet(&self,  params: SetCustomerRefIdForInternalWalletParams ) -> Result<(), Error<SetCustomerRefIdForInternalWalletError>> {
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            ...
            let local_var_entity: Option<SetCustomerRefIdForInternalWalletError> = serde_json::from_str(&local_var_content).ok();
            let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
            Err(Error::ResponseError(local_var_error))
        }
    }
...
/// struct for typed errors of method [`set_customer_ref_id_for_internal_wallet`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]

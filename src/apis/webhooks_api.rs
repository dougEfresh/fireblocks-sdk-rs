...
pub trait WebhooksApi: Send + Sync {
    async fn resend_transaction_webhooks(&self,  params: ResendTransactionWebhooksParams ) -> Result<models::ResendWebhooksByTransactionIdResponse, Error<ResendTransactionWebhooksError>>;
    async fn resend_webhooks(&self,  params: ResendWebhooksParams ) -> Result<models::ResendWebhooksResponse, Error<ResendWebhooksError>>;
}
...
impl WebhooksApi for WebhooksApiClient {
    ...
    async fn resend_transaction_webhooks(&self,  params: ResendTransactionWebhooksParams ) -> Result<models::ResendWebhooksByTransactionIdResponse, Error<ResendTransactionWebhooksError>> {
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            ...
            let local_var_entity: Option<ResendTransactionWebhooksError> = serde_json::from_str(&local_var_content).ok();
    ...
    async fn resend_webhooks(&self,  params: ResendWebhooksParams ) -> Result<models::ResendWebhooksResponse, Error<ResendWebhooksError>> {
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            ...
            let local_var_entity: Option<ResendWebhooksError> = serde_json::from_str(&local_var_content).ok();
            let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
            Err(Error::ResponseError(local_var_error))
        }
    }

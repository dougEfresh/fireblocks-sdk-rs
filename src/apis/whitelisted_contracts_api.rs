...
pub trait WhitelistedContractsApi: Send + Sync {
    async fn add_contract_asset(&self,  params: AddContractAssetParams ) -> Result<models::ExternalWalletAsset, Error<AddContractAssetError>>;
    async fn create_contract(&self,  params: CreateContractParams ) -> Result<models::UnmanagedWallet, Error<CreateContractError>>;
    async fn delete_contract(&self,  params: DeleteContractParams ) -> Result<(), Error<DeleteContractError>>;
    async fn delete_contract_asset(&self,  params: DeleteContractAssetParams ) -> Result<(), Error<DeleteContractAssetError>>;
    async fn get_contract(&self,  params: GetContractParams ) -> Result<models::UnmanagedWallet, Error<GetContractError>>;
    async fn get_contract_asset(&self,  params: GetContractAssetParams ) -> Result<models::ExternalWalletAsset, Error<GetContractAssetError>>;
    async fn get_contracts(&self, ) -> Result<Vec<models::UnmanagedWallet>, Error<GetContractsError>>;
}
...
impl WhitelistedContractsApi for WhitelistedContractsApiClient {
    ...
    async fn add_contract_asset(&self,  params: AddContractAssetParams ) -> Result<models::ExternalWalletAsset, Error<AddContractAssetError>> {
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            ...
            let local_var_entity: Option<AddContractAssetError> = serde_json::from_str(&local_var_content).ok();
    ...
    async fn delete_contract(&self,  params: DeleteContractParams ) -> Result<(), Error<DeleteContractError>> {
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            ...
            let local_var_entity: Option<DeleteContractError> = serde_json::from_str(&local_var_content).ok();
            let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
            Err(Error::ResponseError(local_var_error))
        }
    }
    ...
    async fn delete_contract_asset(&self,  params: DeleteContractAssetParams ) -> Result<(), Error<DeleteContractAssetError>> {
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            ...
            let local_var_entity: Option<DeleteContractAssetError> = serde_json::from_str(&local_var_content).ok();
            let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
            Err(Error::ResponseError(local_var_error))
        }
    }
    ...
    async fn get_contract_asset(&self,  params: GetContractAssetParams ) -> Result<models::ExternalWalletAsset, Error<GetContractAssetError>> {
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            ...
            let local_var_entity: Option<GetContractAssetError> = serde_json::from_str(&local_var_content).ok();
            let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
            Err(Error::ResponseError(local_var_error))
        }
    }

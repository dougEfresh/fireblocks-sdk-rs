...
pub trait FireblocksNetworkApi: Send + Sync {
    async fn check_third_party_routing(&self,  params: CheckThirdPartyRoutingParams ) -> Result<models::ThirdPartyRouting, Error<CheckThirdPartyRoutingError>>;
    async fn create_network_connection(&self,  params: CreateNetworkConnectionParams ) -> Result<models::NetworkConnectionResponse, Error<CreateNetworkConnectionError>>;
    async fn create_network_id(&self,  params: CreateNetworkIdParams ) -> Result<models::NetworkIdResponse, Error<CreateNetworkIdError>>;
    async fn delete_network_connection(&self,  params: DeleteNetworkConnectionParams ) -> Result<models::DeleteNetworkConnectionResponse, Error<DeleteNetworkConnectionError>>;
    async fn delete_network_id(&self,  params: DeleteNetworkIdParams ) -> Result<models::DeleteNetworkIdResponse, Error<DeleteNetworkIdError>>;
    async fn get_network(&self,  params: GetNetworkParams ) -> Result<models::NetworkConnectionResponse, Error<GetNetworkError>>;
    async fn get_network_connections(&self, ) -> Result<Vec<models::NetworkConnectionResponse>, Error<GetNetworkConnectionsError>>;
    async fn get_network_id(&self,  params: GetNetworkIdParams ) -> Result<models::NetworkIdResponse, Error<GetNetworkIdError>>;
    async fn get_network_ids(&self, ) -> Result<Vec<models::NetworkIdResponse>, Error<GetNetworkIdsError>>;
    async fn get_routing_policy_asset_groups(&self, ) -> Result<Vec<String>, Error<GetRoutingPolicyAssetGroupsError>>;
    async fn set_network_id_discoverability(&self,  params: SetNetworkIdDiscoverabilityParams ) -> Result<models::SetNetworkIdResponse, Error<SetNetworkIdDiscoverabilityError>>;
    async fn set_network_id_name(&self,  params: SetNetworkIdNameParams ) -> Result<models::SetNetworkIdResponse, Error<SetNetworkIdNameError>>;
    async fn set_network_id_routing_policy(&self,  params: SetNetworkIdRoutingPolicyParams ) -> Result<models::SetNetworkIdResponse, Error<SetNetworkIdRoutingPolicyError>>;
    async fn set_routing_policy(&self,  params: SetRoutingPolicyParams ) -> Result<models::SetRoutingPolicyResponse, Error<SetRoutingPolicyError>>;
}
...
impl FireblocksNetworkApi for FireblocksNetworkApiClient {
    ...
    async fn check_third_party_routing(&self,  params: CheckThirdPartyRoutingParams ) -> Result<models::ThirdPartyRouting, Error<CheckThirdPartyRoutingError>> {
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            ...
            let local_var_entity: Option<CheckThirdPartyRoutingError> = serde_json::from_str(&local_var_content).ok();
    ...
    async fn create_network_connection(&self,  params: CreateNetworkConnectionParams ) -> Result<models::NetworkConnectionResponse, Error<CreateNetworkConnectionError>> {
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            ...
            let local_var_entity: Option<CreateNetworkConnectionError> = serde_json::from_str(&local_var_content).ok();
            let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
            Err(Error::ResponseError(local_var_error))
        }
    }
    ...
    async fn create_network_id(&self,  params: CreateNetworkIdParams ) -> Result<models::NetworkIdResponse, Error<CreateNetworkIdError>> {
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            ...
            let local_var_entity: Option<CreateNetworkIdError> = serde_json::from_str(&local_var_content).ok();
            let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
            Err(Error::ResponseError(local_var_error))
        }
    }
    ...
    async fn delete_network_connection(&self,  params: DeleteNetworkConnectionParams ) -> Result<models::DeleteNetworkConnectionResponse, Error<DeleteNetworkConnectionError>> {
        ...
        let DeleteNetworkConnectionParams {
            connection_id,
        } = params;
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            ...
            let local_var_entity: Option<DeleteNetworkConnectionError> = serde_json::from_str(&local_var_content).ok();
            let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
            Err(Error::ResponseError(local_var_error))
        }
    }
    ...
    async fn delete_network_id(&self,  params: DeleteNetworkIdParams ) -> Result<models::DeleteNetworkIdResponse, Error<DeleteNetworkIdError>> {
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            ...
            let local_var_entity: Option<DeleteNetworkIdError> = serde_json::from_str(&local_var_content).ok();
            let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
            Err(Error::ResponseError(local_var_error))
        }
    }
    ...
    async fn get_network_connections(&self, ) -> Result<Vec<models::NetworkConnectionResponse>, Error<GetNetworkConnectionsError>> {
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            ...
            let local_var_entity: Option<GetNetworkConnectionsError> = serde_json::from_str(&local_var_content).ok();
            let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
            Err(Error::ResponseError(local_var_error))
        }
    }
    ...
    async fn get_network_id(&self,  params: GetNetworkIdParams ) -> Result<models::NetworkIdResponse, Error<GetNetworkIdError>> {
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            ...
            let local_var_entity: Option<GetNetworkIdError> = serde_json::from_str(&local_var_content).ok();
            let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
            Err(Error::ResponseError(local_var_error))
        }
    }
    ...
    async fn get_network_ids(&self, ) -> Result<Vec<models::NetworkIdResponse>, Error<GetNetworkIdsError>> {
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            ...
            let local_var_entity: Option<GetNetworkIdsError> = serde_json::from_str(&local_var_content).ok();
            let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
            Err(Error::ResponseError(local_var_error))
        }
    }
    ...
    async fn get_routing_policy_asset_groups(&self, ) -> Result<Vec<String>, Error<GetRoutingPolicyAssetGroupsError>> {
        ...
        let local_var_uri_str = format!("{}/network_ids/routing_policy_asset_groups", local_var_configuration.base_path);
        let mut local_var_req_builder = local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            ...
            let local_var_entity: Option<GetRoutingPolicyAssetGroupsError> = serde_json::from_str(&local_var_content).ok();
            let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
            Err(Error::ResponseError(local_var_error))
        }
    }
    ...
    async fn set_network_id_discoverability(&self,  params: SetNetworkIdDiscoverabilityParams ) -> Result<models::SetNetworkIdResponse, Error<SetNetworkIdDiscoverabilityError>> {
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            ...
            let local_var_entity: Option<SetNetworkIdDiscoverabilityError> = serde_json::from_str(&local_var_content).ok();
            let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
            Err(Error::ResponseError(local_var_error))
        }
    }
    ...
    async fn set_network_id_name(&self,  params: SetNetworkIdNameParams ) -> Result<models::SetNetworkIdResponse, Error<SetNetworkIdNameError>> {
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            ...
            let local_var_entity: Option<SetNetworkIdNameError> = serde_json::from_str(&local_var_content).ok();
            let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
            Err(Error::ResponseError(local_var_error))
        }
    }
    ...
    async fn set_network_id_routing_policy(&self,  params: SetNetworkIdRoutingPolicyParams ) -> Result<models::SetNetworkIdResponse, Error<SetNetworkIdRoutingPolicyError>> {
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            ...
            let local_var_entity: Option<SetNetworkIdRoutingPolicyError> = serde_json::from_str(&local_var_content).ok();
            let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
            Err(Error::ResponseError(local_var_error))
        }
    }
    ...
    async fn set_routing_policy(&self,  params: SetRoutingPolicyParams ) -> Result<models::SetRoutingPolicyResponse, Error<SetRoutingPolicyError>> {
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            ...
            let local_var_entity: Option<SetRoutingPolicyError> = serde_json::from_str(&local_var_content).ok();
            let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
            Err(Error::ResponseError(local_var_error))
        }
    }

...
pub trait ExchangeAccountsApi: Send + Sync {
    async fn convert_assets(&self,  params: ConvertAssetsParams ) -> Result<models::ConvertAssetsResponse, Error<ConvertAssetsError>>;
    async fn get_exchange_account(&self,  params: GetExchangeAccountParams ) -> Result<models::ExchangeAccount, Error<GetExchangeAccountError>>;
    async fn get_exchange_account_asset(&self,  params: GetExchangeAccountAssetParams ) -> Result<models::ExchangeAsset, Error<GetExchangeAccountAssetError>>;
    async fn get_paged_exchange_accounts(&self,  params: GetPagedExchangeAccountsParams ) -> Result<Vec<models::ExchangeAccountsPaged>, Error<GetPagedExchangeAccountsError>>;
    async fn internal_transfer(&self,  params: InternalTransferParams ) -> Result<models::InternalTransferResponse, Error<InternalTransferError>>;
}
...
impl ExchangeAccountsApi for ExchangeAccountsApiClient {
    ...
    async fn convert_assets(&self,  params: ConvertAssetsParams ) -> Result<models::ConvertAssetsResponse, Error<ConvertAssetsError>> {
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            ...
            let local_var_entity: Option<ConvertAssetsError> = serde_json::from_str(&local_var_content).ok();
    ...
    async fn get_exchange_account(&self,  params: GetExchangeAccountParams ) -> Result<models::ExchangeAccount, Error<GetExchangeAccountError>> {
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            ...
            let local_var_entity: Option<GetExchangeAccountError> = serde_json::from_str(&local_var_content).ok();
            let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
            Err(Error::ResponseError(local_var_error))
        }
    }
    ...
    async fn get_exchange_account_asset(&self,  params: GetExchangeAccountAssetParams ) -> Result<models::ExchangeAsset, Error<GetExchangeAccountAssetError>> {
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            ...
            let local_var_entity: Option<GetExchangeAccountAssetError> = serde_json::from_str(&local_var_content).ok();
            let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
            Err(Error::ResponseError(local_var_error))
        }
    }
    ...
    async fn get_paged_exchange_accounts(&self,  params: GetPagedExchangeAccountsParams ) -> Result<Vec<models::ExchangeAccountsPaged>, Error<GetPagedExchangeAccountsError>> {
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            ...
            let local_var_entity: Option<GetPagedExchangeAccountsError> = serde_json::from_str(&local_var_content).ok();
            let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
            Err(Error::ResponseError(local_var_error))
        }
    }
    ...
    async fn internal_transfer(&self,  params: InternalTransferParams ) -> Result<models::InternalTransferResponse, Error<InternalTransferError>> {
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            ...
            let local_var_entity: Option<InternalTransferError> = serde_json::from_str(&local_var_content).ok();
            let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
            Err(Error::ResponseError(local_var_error))
        }
    }

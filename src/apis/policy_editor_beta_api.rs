...
pub trait PolicyEditorBetaApi: Send + Sync {
    async fn get_active_policy(&self, ) -> Result<models::PolicyAndValidationResponse, Error<GetActivePolicyError>>;
    async fn get_draft(&self, ) -> Result<models::DraftReviewAndValidationResponse, Error<GetDraftError>>;
    async fn publish_draft(&self,  params: PublishDraftParams ) -> Result<models::PublishResult, Error<PublishDraftError>>;
    async fn publish_policy_rules(&self,  params: PublishPolicyRulesParams ) -> Result<models::PublishResult, Error<PublishPolicyRulesError>>;
    async fn update_draft(&self,  params: UpdateDraftParams ) -> Result<models::DraftReviewAndValidationResponse, Error<UpdateDraftError>>;
}
...
impl PolicyEditorBetaApi for PolicyEditorBetaApiClient {
    ...
    async fn get_active_policy(&self, ) -> Result<models::PolicyAndValidationResponse, Error<GetActivePolicyError>> {
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            ...
            let local_var_entity: Option<GetActivePolicyError> = serde_json::from_str(&local_var_content).ok();
    ...
    async fn publish_draft(&self,  params: PublishDraftParams ) -> Result<models::PublishResult, Error<PublishDraftError>> {
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            ...
            let local_var_entity: Option<PublishDraftError> = serde_json::from_str(&local_var_content).ok();
            let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
            Err(Error::ResponseError(local_var_error))
        }
    }
    ...
    async fn publish_policy_rules(&self,  params: PublishPolicyRulesParams ) -> Result<models::PublishResult, Error<PublishPolicyRulesError>> {
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            ...
            let local_var_entity: Option<PublishPolicyRulesError> = serde_json::from_str(&local_var_content).ok();
            let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
            Err(Error::ResponseError(local_var_error))
        }
    }

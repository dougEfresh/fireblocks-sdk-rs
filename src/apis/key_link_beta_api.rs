...
pub trait KeyLinkBetaApi: Send + Sync {
    async fn create_signing_key(&self,  params: CreateSigningKeyParams ) -> Result<models::SigningKeyDto, Error<CreateSigningKeyError>>;
    async fn create_validation_key(&self,  params: CreateValidationKeyParams ) -> Result<models::CreateValidationKeyResponseDto, Error<CreateValidationKeyError>>;
    async fn disable_validation_key(&self,  params: DisableValidationKeyParams ) -> Result<models::ValidationKeyDto, Error<DisableValidationKeyError>>;
    async fn get_signing_key(&self,  params: GetSigningKeyParams ) -> Result<models::SigningKeyDto, Error<GetSigningKeyError>>;
    async fn get_signing_keys_list(&self,  params: GetSigningKeysListParams ) -> Result<models::GetSigningKeyResponseDto, Error<GetSigningKeysListError>>;
    async fn get_validation_key(&self,  params: GetValidationKeyParams ) -> Result<models::ValidationKeyDto, Error<GetValidationKeyError>>;
    async fn get_validation_keys_list(&self,  params: GetValidationKeysListParams ) -> Result<models::GetValidationKeyResponseDto, Error<GetValidationKeysListError>>;
    async fn set_agent_id(&self,  params: SetAgentIdParams ) -> Result<(), Error<SetAgentIdError>>;
    async fn update_signing_key(&self,  params: UpdateSigningKeyParams ) -> Result<models::SigningKeyDto, Error<UpdateSigningKeyError>>;
}
...
impl KeyLinkBetaApi for KeyLinkBetaApiClient {
    ...
    async fn create_signing_key(&self,  params: CreateSigningKeyParams ) -> Result<models::SigningKeyDto, Error<CreateSigningKeyError>> {
        ...
        let local_var_uri_str = format!("{}/key_link/signing_keys", local_var_configuration.base_path);
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            ...
            let local_var_entity: Option<CreateSigningKeyError> = serde_json::from_str(&local_var_content).ok();
    ...
    async fn create_validation_key(&self,  params: CreateValidationKeyParams ) -> Result<models::CreateValidationKeyResponseDto, Error<CreateValidationKeyError>> {
        ...
        let local_var_uri_str = format!("{}/key_link/validation_keys", local_var_configuration.base_path);
        let mut local_var_req_builder = local_var_client.request(reqwest::Method::POST, local_var_uri_str.as_str());
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            ...
            let local_var_entity: Option<CreateValidationKeyError> = serde_json::from_str(&local_var_content).ok();
            let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
            Err(Error::ResponseError(local_var_error))
        }
    }
    ...
    async fn disable_validation_key(&self,  params: DisableValidationKeyParams ) -> Result<models::ValidationKeyDto, Error<DisableValidationKeyError>> {
        ...
        let local_var_uri_str = format!("{}/key_link/validation_keys/{keyId}", local_var_configuration.base_path, keyId=crate::apis::urlencode(key_id));
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            ...
            let local_var_entity: Option<DisableValidationKeyError> = serde_json::from_str(&local_var_content).ok();
            let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
            Err(Error::ResponseError(local_var_error))
        }
    }
    ...
    async fn get_signing_key(&self,  params: GetSigningKeyParams ) -> Result<models::SigningKeyDto, Error<GetSigningKeyError>> {
        ...
        let local_var_uri_str = format!("{}/key_link/signing_keys/{keyId}", local_var_configuration.base_path, keyId=crate::apis::urlencode(key_id));
    ...
    async fn get_signing_keys_list(&self,  params: GetSigningKeysListParams ) -> Result<models::GetSigningKeyResponseDto, Error<GetSigningKeysListError>> {
        ...
        if let Some(ref local_var_str) = vault_account_id {
            local_var_req_builder = local_var_req_builder.query(&[("vaultAccountId", &local_var_str.to_string())]);
        }
        ...
        if let Some(ref local_var_str) = algorithm {
            local_var_req_builder = local_var_req_builder.query(&[("algorithm", &local_var_str.to_string())]);
        }
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            ...
            let local_var_entity: Option<GetSigningKeysListError> = serde_json::from_str(&local_var_content).ok();
            let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
            Err(Error::ResponseError(local_var_error))
        }
    }
    ...
    async fn get_validation_key(&self,  params: GetValidationKeyParams ) -> Result<models::ValidationKeyDto, Error<GetValidationKeyError>> {
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            ...
            let local_var_entity: Option<GetValidationKeyError> = serde_json::from_str(&local_var_content).ok();
            let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
            Err(Error::ResponseError(local_var_error))
        }
    }
    ...
    async fn get_validation_keys_list(&self,  params: GetValidationKeysListParams ) -> Result<models::GetValidationKeyResponseDto, Error<GetValidationKeysListError>> {
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            ...
            let local_var_entity: Option<GetValidationKeysListError> = serde_json::from_str(&local_var_content).ok();
            let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
            Err(Error::ResponseError(local_var_error))
        }
    }
    ...
    async fn set_agent_id(&self,  params: SetAgentIdParams ) -> Result<(), Error<SetAgentIdError>> {
        ...
        let local_var_uri_str = format!("{}/key_link/signing_keys/{keyId}/agent_user_id", local_var_configuration.base_path, keyId=crate::apis::urlencode(key_id));
        let mut local_var_req_builder = local_var_client.request(reqwest::Method::PATCH, local_var_uri_str.as_str());
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            ...
            let local_var_entity: Option<SetAgentIdError> = serde_json::from_str(&local_var_content).ok();
            let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
            Err(Error::ResponseError(local_var_error))
        }
    }

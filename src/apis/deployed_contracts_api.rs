...
pub trait DeployedContractsApi: Send + Sync {
    async fn add_contract_abi(&self,  params: AddContractAbiParams ) -> Result<models::ContractWithAbiDto, Error<AddContractAbiError>>;
    async fn fetch_contract_abi(&self,  params: FetchContractAbiParams ) -> Result<models::ContractWithAbiDto, Error<FetchContractAbiError>>;
    async fn get_deployed_contract_by_address(&self,  params: GetDeployedContractByAddressParams ) -> Result<models::DeployedContractResponseDto, Error<GetDeployedContractByAddressError>>;
    async fn get_deployed_contract_by_id(&self,  params: GetDeployedContractByIdParams ) -> Result<models::DeployedContractResponseDto, Error<GetDeployedContractByIdError>>;
    async fn get_deployed_contracts(&self,  params: GetDeployedContractsParams ) -> Result<models::DeployedContractsPaginatedResponse, Error<GetDeployedContractsError>>;
}
...
impl DeployedContractsApi for DeployedContractsApiClient {
    ...
    async fn add_contract_abi(&self,  params: AddContractAbiParams ) -> Result<models::ContractWithAbiDto, Error<AddContractAbiError>> {
        ...
        let local_var_uri_str = format!("{}/tokenization/contracts/abi", local_var_configuration.base_path);
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            ...
            let local_var_entity: Option<AddContractAbiError> = serde_json::from_str(&local_var_content).ok();
    ...
    async fn fetch_contract_abi(&self,  params: FetchContractAbiParams ) -> Result<models::ContractWithAbiDto, Error<FetchContractAbiError>> {
        ...
        let local_var_uri_str = format!("{}/tokenization/contracts/fetch_abi", local_var_configuration.base_path);
        let mut local_var_req_builder = local_var_client.request(reqwest::Method::POST, local_var_uri_str.as_str());
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            ...
            let local_var_entity: Option<FetchContractAbiError> = serde_json::from_str(&local_var_content).ok();
            let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
            Err(Error::ResponseError(local_var_error))
        }
    }
    ...
    async fn get_deployed_contract_by_address(&self,  params: GetDeployedContractByAddressParams ) -> Result<models::DeployedContractResponseDto, Error<GetDeployedContractByAddressError>> {
        ...
        let local_var_uri_str = format!("{}/tokenization/contracts/{assetId}/{contractAddress}", local_var_configuration.base_path, contractAddress=crate::apis::urlencode(contract_address), assetId=crate::apis::urlencode(asset_id));
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            ...
            let local_var_entity: Option<GetDeployedContractByAddressError> = serde_json::from_str(&local_var_content).ok();
            let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
            Err(Error::ResponseError(local_var_error))
        }
    }
    ...
    async fn get_deployed_contract_by_id(&self,  params: GetDeployedContractByIdParams ) -> Result<models::DeployedContractResponseDto, Error<GetDeployedContractByIdError>> {
        ...
        let GetDeployedContractByIdParams {
            id,
        } = params;
        ...
        let local_var_uri_str = format!("{}/tokenization/contracts/{id}", local_var_configuration.base_path, id=crate::apis::urlencode(id));
        let mut local_var_req_builder = local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            ...
            let local_var_entity: Option<GetDeployedContractByIdError> = serde_json::from_str(&local_var_content).ok();
            let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
            Err(Error::ResponseError(local_var_error))
        }
    }
    ...
    async fn get_deployed_contracts(&self,  params: GetDeployedContractsParams ) -> Result<models::DeployedContractsPaginatedResponse, Error<GetDeployedContractsError>> {
        ...
        let local_var_uri_str = format!("{}/tokenization/contracts", local_var_configuration.base_path);
        let mut local_var_req_builder = local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            ...
            let local_var_entity: Option<GetDeployedContractsError> = serde_json::from_str(&local_var_content).ok();
            let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
            Err(Error::ResponseError(local_var_error))
        }
    }

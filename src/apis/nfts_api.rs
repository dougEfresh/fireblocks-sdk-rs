...
pub trait NftsApi: Send + Sync {
    ...
    async fn get_nfts(&self,  params: GetNftsParams ) -> Result<models::ListOwnedTokens200Response, Error<GetNftsError>>;
    async fn get_owned_nfts(&self,  params: GetOwnedNftsParams ) -> Result<models::GetOwnedNfts200Response, Error<GetOwnedNftsError>>;
    async fn list_owned_collections(&self,  params: ListOwnedCollectionsParams ) -> Result<models::ListOwnedCollections200Response, Error<ListOwnedCollectionsError>>;
    async fn list_owned_tokens(&self,  params: ListOwnedTokensParams ) -> Result<models::ListOwnedTokens200Response, Error<ListOwnedTokensError>>;
    async fn refresh_nft_metadata(&self,  params: RefreshNftMetadataParams ) -> Result<(), Error<RefreshNftMetadataError>>;
    async fn refresh_nft_ownership_by_vault(&self,  params: RefreshNftOwnershipByVaultParams ) -> Result<(), Error<RefreshNftOwnershipByVaultError>>;
...
/// struct for passing parameters to the method [`get_owned_nfts`]
#[derive(Clone, Debug)]
#[cfg_attr(feature = "bon", derive(::bon::Builder))]
pub struct GetOwnedNftsParams {
...
/// struct for passing parameters to the method [`refresh_nft_ownership_by_vault`]
#[derive(Clone, Debug)]
#[cfg_attr(feature = "bon", derive(::bon::Builder))]
pub struct RefreshNftOwnershipByVaultParams {
    /// Blockchain descriptor filter
...
impl NftsApi for NftsApiClient {
    ...
    async fn get_owned_nfts(&self,  params: GetOwnedNftsParams ) -> Result<models::GetOwnedNfts200Response, Error<GetOwnedNftsError>> {
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            ...
            let local_var_entity: Option<GetOwnedNftsError> = serde_json::from_str(&local_var_content).ok();
            let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
            Err(Error::ResponseError(local_var_error))
        }
    }
    ...
    async fn refresh_nft_ownership_by_vault(&self,  params: RefreshNftOwnershipByVaultParams ) -> Result<(), Error<RefreshNftOwnershipByVaultError>> {
        ...
        let RefreshNftOwnershipByVaultParams {
            blockchain_descriptor,
            vault_account_id,
        } = params;
        ...
        if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
            ...
            let local_var_entity: Option<RefreshNftOwnershipByVaultError> = serde_json::from_str(&local_var_content).ok();
            let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
            Err(Error::ResponseError(local_var_error))
        }
    }
    ...
    async fn update_tokens_ownership_spam(&self,  params: UpdateTokensOwnershipSpamParams ) -> Result<(), Error<UpdateTokensOwnershipSpamError>> {
        ...
        let local_var_uri_str = format!("{}/api/v1/nfts/ownership/tokens/spam", local_var_configuration.base_path);
        let mut local_var_req_builder = local_var_client.request(reqwest::Method::PUT, local_var_uri_str.as_str());
...
/// struct for typed errors of method [`get_owned_nfts`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum GetOwnedNftsError {
    UnknownValue(serde_json::Value),
}
...
/// struct for typed errors of method [`refresh_nft_ownership_by_vault`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum RefreshNftOwnershipByVaultError {
    UnknownValue(serde_json::Value),
}

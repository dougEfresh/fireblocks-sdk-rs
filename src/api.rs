...
use crate::{Result, types::{
  ...
  vault::{Account, CreateAccount, VaultAccounts}, wallet::{WalletContainer, WalletCreate, WalletCreateAsset, WalletCreateAssetResponse},
}};
...
impl FireblocksClient {
  ...
  pub async fn assets(&self, page: Option<&PagingVaultRequest>, greater_than: Option<f64>) -> Result<PaginatedAssetWallet> {

...
impl AddAssetToExternalWalletRequestOneOf1AdditionalInfoOneOf {
    pub fn new(account_holder_given_name: String, account_holder_city: String, account_holder_country: String, account_holder_address1: String, account_holder_postal_code: String, iban: String, iban_city: String, iban_country: String) -> AddAssetToExternalWalletRequestOneOf1AdditionalInfoOneOf {

...
pub struct DisbursementValidationFailure {
    #[serde(rename = "reason")]
    pub reason: Reason,
...
impl DisbursementValidationFailure {
    pub fn new(reason: Reason) -> DisbursementValidationFailure {
        DisbursementValidationFailure { reason, data: None }
    }
}
///
...
pub enum Reason {
    ...
    #[serde(rename = "INSTRUCTIONS_EXCEED_HUNDRED_PERCENT")]
    InstructionsExceedHundredPercent,
    #[serde(rename = "INSTRUCTIONS_ARRAY_EMPTY")]
    InstructionsArrayEmpty,
}

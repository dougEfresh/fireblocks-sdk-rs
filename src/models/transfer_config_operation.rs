...
impl TransferConfigOperation {
    pub fn new(operation_id: String, r#type: models::TransferOperationType, params: models::TransferOperationConfigParams, status: models::ConfigOperationStatus) -> TransferConfigOperation {

...
pub struct SmartTransferCreateTicketDto {
    ...
    pub terms: Option<Vec<models::SmartTransferCreateTicketTermDto>>,
...
impl SmartTransferCreateTicketDto {
    pub fn new(created_by_network_id: String, r#type: Type) -> SmartTransferCreateTicketDto {

...
pub struct ExternalWalletsWalletIdAssetIdPostRequestOneOf {
...
impl ExternalWalletsWalletIdAssetIdPostRequestOneOf {
    pub fn new(address: String) -> ExternalWalletsWalletIdAssetIdPostRequestOneOf {

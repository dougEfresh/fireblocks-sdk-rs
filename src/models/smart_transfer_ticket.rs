...
impl SmartTransferTicket {
    ...
    pub fn new(id: String, r#type: Type, status: Status, created_by_network_id: String, created_by_network_id_name: String, created_at: String, updated_at: String) -> SmartTransferTicket {
        SmartTransferTicket {
            id,
            r#type,
            direction: None,

...
impl SigningKeyDto {
    pub fn new(key_id: String, signing_device_key_id: String, public_key_pem: String, algorithm: String, enabled: bool, vault_account_id: Option<f64>, agent_user_id: String, created_at: f64) -> SigningKeyDto {
        SigningKeyDto {
            key_id,

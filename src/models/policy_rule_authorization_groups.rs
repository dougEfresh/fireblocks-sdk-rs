...
pub struct PolicyRuleAuthorizationGroups {
    /// * AND - requires approval of all authorization groups * OR - requires
    ///   approval of at least one of the authorization groups
    #[serde(rename = "logic", skip_serializing_if = "Option::is_none")]
    pub logic: Option<Logic>,
    /// Defines whether the user who initiates a transaction can approve their
    /// own transaction and count toward the approval threshold for their
    /// transaction
    #[serde(

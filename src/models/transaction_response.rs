...
pub struct TransactionResponse {
    ...
    #[serde(rename = "contractCallDecodedData", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "amountUSD", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
...
impl TransactionResponse {
    pub fn new(id: String, status: models::TransactionStatus, operation: models::GetTransactionOperation) -> TransactionResponse {
        TransactionResponse {
            id,
            external_tx_id: None,
            status,

...
pub struct ExternalWalletsWalletIdAssetIdPostRequestOneOf1AdditionalInfoOneOf1 {
...
impl ExternalWalletsWalletIdAssetIdPostRequestOneOf1AdditionalInfoOneOf1 {
    pub fn new(account_holder_given_name: String, account_holder_city: String, account_holder_country: String, account_holder_address1: String, account_holder_postal_code: String, aba_routing_number: String, aba_account_number: String, aba_country: String) -> ExternalWalletsWalletIdAssetIdPostRequestOneOf1AdditionalInfoOneOf1 {

...
impl ConversionConfigOperation {
    pub fn new(operation_id: String, r#type: models::ConversionOperationType, params: models::ConversionOperationConfigParams, status: models::ConfigOperationStatus) -> ConversionConfigOperation {

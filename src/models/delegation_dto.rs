...
pub struct DelegationDto {
    ...
    /// amount of tokens to unstake, and the transaction ID of the request.
    /// With Lido, a position may have multiple partial unstake requests in
    /// different states. This field is optional and not applicable for other
    /// providers.
...
impl DelegationDto {
    pub fn new(
        ...
        date_created: String,
        status: Status,
        related_transactions: Vec<models::RelatedTransactionDto>,
        validator_address: String,
        provider_id: String,
        available_actions: Vec<String>,
        in_progress: bool,
        blockchain_position_info: models::SolanaBlockchainDataDto,
    ) -> DelegationDto {
        DelegationDto {
            id,
            vault_account_id,

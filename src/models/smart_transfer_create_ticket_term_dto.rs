...
pub struct SmartTransferCreateTicketTermDto {
    /// Asset name
    #[serde(rename = "asset")]
    pub asset: String,
    /// Amount
...
impl SmartTransferCreateTicketTermDto {
    pub fn new(asset: String, amount: f64, from_network_id: String, to_network_id: String) -> SmartTransferCreateTicketTermDto {

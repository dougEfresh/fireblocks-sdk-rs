...
pub struct PolicyRule {
    ...
    #[serde(rename = "authorizationGroups", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "applyForTypedMessage", skip_serializing_if = "Option::is_none")]
    pub apply_for_typed_message: Option<bool>,
    /// A unique id identifying the rule
    #[serde(rename = "externalDescriptor")]
    pub external_descriptor: String,
}

impl PolicyRule {
    /// Policy rule which is enforced on transactions
    pub fn new(r#type: Type, action: Action, asset: String, amount_currency: AmountCurrency, amount_scope: AmountScope, amount: models::PolicyRuleAmount, period_sec: f64, external_descriptor: String) -> PolicyRule {
        PolicyRule {
            operator: None,
            operators: None,

...
impl PolicyRule {
    ...
    pub fn new(r#type: Type, action: Action, asset: String, amount_currency: AmountCurrency, amount_scope: AmountScope, amount: models::PolicyRuleAmount, period_sec: f64) -> PolicyRule {
        PolicyRule {
            operator: None,
            operators: None,

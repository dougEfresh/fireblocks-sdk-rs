...
impl SessionDto {
    pub fn new(id: String, user_id: String, session_metadata: models::SessionMetadata, vault_account_id: f64, fee_level: FeeLevel, chain_ids: Vec<String>, connection_type: ConnectionType, connection_method: ConnectionMethod, creation_date: String) -> SessionDto {
        SessionDto {
            id,
            user_id,
            session_metadata,
